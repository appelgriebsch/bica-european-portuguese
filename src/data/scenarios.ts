import type { SpeakScenario } from "./types";

export const speakScenarios: SpeakScenario[] = [
  {
    id: "pastelaria",
    level: "A1",
    minutes: 8,
    ...
    setting:
      "You are at the counter of a neighbourhood pastelaria in Campo de Ourique, Lisbon. Morning rush. Order a drink and something to eat. Pay. Be brief and polite.",
  ...
  },
  {
    ...
    setting:
      "You are on a steep Alfama street, looking for tram 28 or the castle entrance. Ask a local. Confirm left, right, walking time.",
  ...
  },
  {
    ...
    titlePt: "O bilhete",
    setting:
      "Cais do Sodré station. You need a train ticket to Cascais, return, for today. Ask about times and price.",
  ...
  },
  {
    ...
    setting:
      "You are texting — here, speaking — with a Portuguese friend. Propose dinner tomorrow. Negotiate time. One of you will book.",
  ...
  },
  {
    ...
    titlePt: "Na farmácia",
    setting:
      "You have a sore throat and a cough since yesterday, no fever. Describe symptoms. Ask if you need a doctor. Buy something sem receita.",
  ...
  },
  {
    ...
    setting:
      "Monday at a café with a colleague. They ask about your weekend. Tell a short story in the pretérito. Ask them back.",
    partner: "Rui, a colleague",
    openerPt: "Então, como correu o fim de semana?",
    openerEn: "So, how was the weekend?",
    goals: ["Use fui / vi / gostei", "Ask a follow-up", "Keep it to a few sentences"],
  ...
  },
  {
    ...
    setting:
      "You and a neighbour both heard the morning bulletin: rain this afternoon, roadworks on Liberdade. React, plan your route, complain a little.",
    ...
    image: "/scenes/kitchen-radio.svg",
  },
  {
    id: "livro",
    level: "B1",
    ...
    titlePt: "Na livraria",
    setting:
      "A small Lisbon bookshop. You want something not too hard — crónicas, or a novel in clear prose. Ask for a recommendation. Admit your level honestly.",
    ...
    goals: ["Describe your level", "Ask for a recommendation", "Buy or say you'll think about it"],
  ...
  },
  {
    ...
    titlePt: "À mesa",
    setting:
      "A dinner in Arroios. The table is talking about tourism and housing in Lisbon. Take a nuanced position. Concede. Disagree in part. Don't lecture.",
  ...
  },
  {
    ...
    titlePt: "Saudades",
    setting:
      "A balcony at dusk after a month in Portugal. A host asks how you really are. Be precise about feeling. Not a postcard.",
