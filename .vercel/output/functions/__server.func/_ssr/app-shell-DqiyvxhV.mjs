...
import { d as Headphones, m as BookOpen, n as UserRound, u as House } from "../_libs/lucide-react.mjs";
import { n as cn } from "./utils-BjFYziMh.mjs";
import { i as saveProgressSnapshot, n as fetchProgress, o as useCurrentUserState, s as useProgress } from "./progress-server-BcgDNvCB.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/app-shell-DqiyvxhV.js
...
var nav = [
	...
	},
	{
		...
		label: "Practice",
		icon: Headphones,
		match: (p) => p === "/practice" || p.startsWith("/speak") || p.startsWith("/listen") || p.startsWith("/read") || p.startsWith("/review")
	},
	{
		to: "/me",
		label: "You",
