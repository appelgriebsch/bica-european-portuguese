//#region node_modules/.nitro/vite/services/ssr/assets/curriculum-B10PTO8w.js
var a1Lessons = [
	{
		id: "a1-ola",
		level: "A1",
...
function firstIncomplete(completedIds) {
...
function vocabFromCompleted(completedIds) {
	return lessons.filter((l) => completedIds.includes(l.id)).flatMap((l) => l.sections.flatMap((s) => s.type === "vocab" ? s.items : []));
}
lessons.reduce((n, l) => n + l.minutes, 0);
//#endregion
export { getLesson as a, levels as c, readingPieces as d, units as f, getBulletin as i, nextLesson as l, firstIncomplete as n, getReading as o, vocabFromCompleted as p, firstIncompleteOf as r, lessons as s, estimatedLevel as t, radioBulletins as u };
