import { _ as EncryptJWT, f as createDefu, g as calculateJwkThumbprint, h as string, m as boolean, p as defu, v as SignJWT, y as jwtDecrypt } from "../_libs/better-auth+[...].mjs";
import { A as getCurrentAdapter, B as createRouter$1, C as getIp, D as createAuthEndpoint, E as normalizePathname, F as hasRequestState, G as filterOutputFields, H as serializeCookie, I as runWithRequestState, L as getCurrentAuthContext, Lt as encode, M as runWithAdapter, N as runWithTransaction, O as createAuthMiddleware, P as defineRequestState, Q as email, R as runWithEndpointContext, S as findInvalidTrustedProxies, U as serializeSignedCookie, V as toResponse, W as safeJSONParse, X as array, Y as any, Yt as JWTExpired, Z as boolean$1, _ as ATTR_CONTEXT, a as initGetFieldName, at as string$1, b as import_src, bn as isProduction, c as validateAuthorizationCode, cn as BetterAuthError, dt as base64Url, et as looseObject, f as createAuthorizationURL, fn as createLogger, ft as decodeJwt, g as withSpan, gn as env, h as generateId, i as initGetModelName, it as record, j as queueAfterTransactionHook, k as isAPIError, l as refreshAccessToken, ln as kAPIErrorHeaderSymbol, lt as getAuthTables, m as isLoopbackHost, mn as shouldPublishLog, mt as jwtVerify, nt as object, o as SocialProviderListEnum, on as createRandomStringGenerator, p as applyDefaultAccessTokenExpiry, pn as logger, pt as decodeProtectedHeader, rt as optional, s as socialProviders, sn as APIError, tt as number, u as betterFetch, un as BASE_ERROR_CODES, v as ATTR_HOOK_TYPE, w as deprecate, x as createRateLimitKey, xn as isTest, y as ATTR_OPERATION_ID, yn as isDevelopment, z as getBetterAuthVersion } from "../_libs/@better-auth/core+[...].mjs";
...
import { n as getPglite, t as ensureDbReady } from "./db-CX7-emr9.mjs";
import { randomBytes } from "node:crypto";
//#region node_modules/.nitro/vite/services/ssr/assets/server-YmYkrD0q.js
...
function extraPublicHosts() {
	...
	const viteHost = env$1("VITE_PUBLIC_HOSTNAME") ?? (typeof import.meta !== "undefined" ? String("").trim() || void 0 : void 0);
	const extraOrigins = env$1("BETTER_AUTH_TRUSTED_ORIGINS");
	const candidates = [
		explicitBaseURL,
		viteHost,
		env$1("VERCEL_PROJECT_PRODUCTION_URL"),
		env$1("VERCEL_URL"),
		env$1("VERCEL_BRANCH_URL"),
