...
import { $t as checkModulusLength, A as getCurrentAdapter, At as digest, B as createRouter$1, Bt as isKeyLike, C as getIp, Ct as validateCritDuplicates, D as createAuthEndpoint, Dt as jwkToKey, E as normalizePathname, Et as prepareKey, F as hasRequestState, Ft as isJWK, G as filterOutputFields, Gt as JWEInvalid, H as serializeCookie, Ht as JOSEAlgNotAllowed, I as runWithRequestState, It as isObject, Jt as JWTClaimValidationFailed, K as ZodBoolean, Kt as JWKInvalid, L as getCurrentAuthContext, Lt as encode$1, M as runWithAdapter, Mt as parseJoseHeader, N as runWithTransaction, Nt as unprotected, O as createAuthMiddleware, Ot as assertNotSet, P as defineRequestState, Pt as isDisjoint, Q as email, Qt as checkCryptoKey, R as runWithEndpointContext, Rt as assertCryptoKey, S as findInvalidTrustedProxies, St as validateCrit, T as isSafeUrlScheme, Tt as jweEncryption, U as serializeSignedCookie, Ut as JOSENotSupported, V as toResponse, Vt as isKeyObject, W as safeJSONParse, Wt as JWEDecryptionFailed, X as array, Xt as JWTInvalid, Y as any, Yt as JWTExpired, Z as boolean$1, Zt as invalidKeyInput, _ as ATTR_CONTEXT, _t as jwsAlgorithm, a as initGetFieldName, an as uint64be, at as string$1, b as import_src, bn as isProduction, bt as JWS_RECOGNIZED, c as validateAuthorizationCode, cn as BetterAuthError, ct as _coercedString, d as createFetch, dn as defineErrorCodes, dt as base64Url, en as checkUsage, et as looseObject, f as createAuthorizationURL, fn as createLogger, ft as decodeJwt, g as withSpan, gn as env, gt as validateClaimsSet, h as generateId, ht as JWTClaimsBuilder, i as initGetModelName, in as uint32be, it as record, j as queueAfterTransactionHook, jt as encodeBase64url, k as isAPIError, kt as decodeBase64url, l as refreshAccessToken, ln as kAPIErrorHeaderSymbol, lt as getAuthTables, m as isLoopbackHost, mn as shouldPublishLog, mt as jwtVerify, n as toKebabCase, nn as decoder, nt as object, o as SocialProviderListEnum, on as createRandomStringGenerator, p as applyDefaultAccessTokenExpiry, pn as logger, pt as decodeProtectedHeader, q as ZodString, qt as JWSInvalid, rn as encode, rt as optional, s as socialProviders, sn as APIError, st as _coercedBoolean, t as capitalizeFirstLetter, tn as concat, tt as number, u as betterFetch, un as BASE_ERROR_CODES, v as ATTR_HOOK_TYPE, vt as sign, w as deprecate, wt as jweAlgorithm, x as createRateLimitKey, xn as isTest, xt as validateAlgorithms, y as ATTR_OPERATION_ID, yn as isDevelopment, yt as JWE_RECOGNIZED, z as getBetterAuthVersion, zt as isCryptoKey } from "./@better-auth/core+[...].mjs";
...
var signInWithOAuth2BodySchema = object({
	providerId: string$1().meta({ description: "The provider ID for the OAuth provider" }),
	callbackURL: string$1().meta({ description: "The URL to redirect to after sign in" }).optional(),
	errorCallbackURL: string$1().meta({ description: "The URL to redirect to if an error occurs" }).optional(),
	newUserCallbackURL: string$1().meta({ description: "The URL to redirect to after login if the user is new. Eg: \"/welcome\"" }).optional(),
	disableRedirect: boolean$1().meta({ description: "Disable redirect" }).optional(),
	scopes: array(string$1()).meta({ description: "Scopes to be passed to the provider authorization request." }).optional(),
	requestSignUp: boolean$1().meta({ description: "Explicitly request sign-up. Useful when disableImplicitSignUp is true for this provider. Eg: false" }).optional(),
	/**
	* Any additional data to pass through the oauth flow.
	*/
	additionalData: record(string$1(), any()).optional()
...
var OAuth2CallbackQuerySchema = object({
	code: string$1().meta({ description: "The OAuth2 code" }).optional(),
	error: string$1().meta({ description: "The error message, if any" }).optional(),
	error_description: string$1().meta({ description: "The error description, if any" }).optional(),
	state: string$1().meta({ description: "The state parameter from the OAuth2 request" }).optional(),
	iss: string$1().meta({ description: "The issuer identifier" }).optional()
});
...
var OAuth2LinkAccountBodySchema = object({
	...
	* linking a social account compared to the initial authentication.
	*/
	scopes: array(string$1()).meta({ description: "Additional scopes to request when linking the account" }).optional(),
	/**
	* The URL to redirect to if there is an error during the link process.
	*/
	errorCallbackURL: string$1().meta({ description: "The URL to redirect to if there is an error during the link process" }).optional()
		...
		hooks: { after: [{
			...
			handler: createAuthMiddleware(async (ctx) => {
				...
				if (returned instanceof Headers) {
					...
					const { setCookie } = await import("./@tanstack/react-start+[...].mjs").then((n) => n.t);
...
//#endregion
export { EncryptJWT as _, onMount as a, tanstackStartCookies as c, betterAuth as d, createDefu as f, calculateJwkThumbprint as g, string as h, STORE_UNMOUNT_DELAY as i, genericOAuth as l, boolean as m, genericOAuthClient as n, onSet as o, defu as p, listenKeys as r, atom as s, createAuthClient as t, bearer as u, SignJWT as v, jwtDecrypt as y };
